    ...
    if is_image_to_image:
        ...
        instructions.extend(
            [
                ...
                "                print(f'Detected MULTI-LABEL: {n_target_cols} independent labels')",
                "            else:",
                "                problem_type = 'multiclass'",
                "                activation = 'softmax'",
                "                loss = 'categorical_crossentropy'  # or CrossEntropyLoss",
                "                # MUST normalize rows to sum=1",
                "                print(f'Detected MULTI-CLASS: {n_target_cols} mutually exclusive classes')",
                "        else:",
                ...
                "            print(f'Detected MULTI-CLASS: {n_target_cols} classes from single target column')",
                "    ",
                "    print(f'Problem type: {problem_type}, Activation: {activation}, Loss: {loss}')",
                "    ```",
