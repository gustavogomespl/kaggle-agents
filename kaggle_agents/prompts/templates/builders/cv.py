...
def build_stacking_oof_instructions(working_dir: str, component_name: str) -> list[str]:
    ...
    instructions = [
        ...
        f"       np.save(str(Path('{working_dir}') / 'models' / 'train_ids_{component_name}.npy'), train_ids, allow_pickle=False)",
        "       ```",
        ...
        f"       np.save(str(Path('{working_dir}') / 'models' / 'test_ids_{component_name}.npy'), test_ids, allow_pickle=False)",
        "       print(f'[LOG:INFO] Saved test_ids: {{len(test_ids)}} IDs')",
        "       ```",
